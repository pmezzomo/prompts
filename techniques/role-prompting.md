...
**Definição:** Role Prompting é a técnica de atribuir um papel específico à IA (ex: advogado, gerente de projeto, especialista em marketing) antes de pedir uma tarefa. O objetivo é gerar uma resposta alinhada ao ponto de vista, linguagem e tomada de decisão de um profissional daquele papel.
...
← [Voltar para Engenharia de Prompt](../prompt-engineering.md)
